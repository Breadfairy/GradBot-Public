#!/usr/bin/env python3
# summary.py – Backtest summary printing helpers

from __future__ import annotations

from typing import Any, Dict, List, Optional

from accounting import calcIncomeTax, bracketForIncome
from metrics import (
...
from engine_shared import periods_per_year, bars_per_day
...
def _printHeader(labelStr: str, seed: float, quote: str, durationDays: int, rawDays: int, endDt, lastPrice: float) -> None:
...
# ======================================================================
# Backtest summary wrapper
# ======================================================================


def printBacktestSummary(
    ticker: str,
    ts,
    startIdx: int,
    endDt,
...
def printIncomeSummary(
    ...
    _printHeader(labelStr, seed, quote, durationDays, rawDays, endDt, lastPrice)
